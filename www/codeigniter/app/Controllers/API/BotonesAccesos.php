...
use App\Models\BotonesAccesosApiModel;
use CodeIgniter\RESTful\ResourceController;

class BotonesAccesos extends ResourceController
{
    protected $format    = 'json';

    public function __construct()
    {
        $this->modelName = new BotonesAccesosApiModel();
    }
...
/* fecha de creacion: 03-30-2023 03:11:08 pm */